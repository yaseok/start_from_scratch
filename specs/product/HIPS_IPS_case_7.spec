...
예외 IP 설정
* "VS_DUT01"에서 "policy_agent" 설정파일 "/var/policy/policy_agent.json" 정책 "except_ip":"ip"의 string type 설정 "ip"을 <except_ip>로 변경을 한다 xpath는 "body.policy_hips_agent.except_ip.[0].ip" 이다
