...
## additional 대응방법 테스트
* HIPS:"VS_DUT01"에 IPS additional 대응방법 테스트를 위한 정책을 설정 및 적용한다 (<sid>, <action>, <block_action>, <severity>, <direction>, <period>, <threshold>, <blockTime>, <raw>, <recommand>, <alarm>)
* HIPS:"VS_DUT01"에서 TCPDUMP명:"traffic1_dump"으로 인터페이스: "$VS_DUT01.intname"에 대해 TCPDUMP를 수행한다 (<dumpoption1>)
* "ATTACK01"에서 IPS additional 대응방법 테스트의 탐지 트래픽을 발생시킨다 (<traffic_sip>, <sid>)
...
\* HIPS:"VS_DUT01"에서 TCPDUMP명:"traffic1_dump" 내용을 확인한다2 (<recode>, <traffic_sip>, "$VS_DUT01.ip", "5")
