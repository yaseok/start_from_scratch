# engine apply - fw block_nation

Tags: DEVICE.real_cent.ini, DEVICE.nsel_attacker.ini
table: data/engine/table_config_fw_blocknation.csv

## 기본 Setup
* HIPS:"VS_DUT01"에 방화벽 차단 국가 테스트를 위한 기본 설정 파일을 저장하고 설정을 적용한다

## block_nation

* HIPS:"VS_DUT01"에서 엔진의 방화벽 설정을 변경하고 적용한다 (Object Type, <menu>, <xpath>, <path_local>, <path_remote_1>, <path_remote_2>, <value>)
